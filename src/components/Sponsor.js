				...
				<main className={classes.content} style={{ paddingLeft: "50" }}>
					...
					<Container maxWidth="lg" className={classes.container}>
						<Paper>
							...
							毎年皆様のおかげで無事工大祭を運営することができ、昨年度は4000人以上という本当に多くの来場者にお越しいただくことができました。
							工大祭に学生によって運営している学園祭になっております。実行委員一同、少しでも多くの来場者様の笑顔を見たいという思いから日々活動に励んでおります。
							...
							<p style={{ fontSize: "18", marginLeft: "40" }}>工大祭では毎年多くの企業・団体より広告費をいただいただいております。ご協力いただけた企業・団体・個人様につきましては実行委員会が発行する工大祭のパンフレットへの掲載をいたします。<br>
