				...
				<main className={classes.content} style={{ paddingLeft: "50" }}>
					...
					<Container maxWidth="lg" className={classes.container}>
						<Paper>
							...
							皆様のお力により毎年工大祭を運営することができております。昨年度は4000人以上という本当に多くの来場者にお越しいただくことができました。
							工大祭は学生が主体となって運営している学園祭になっており、実行委員一同、少しでも多くの来場者様の笑顔を見たいという思いから日々活動に励んでおります。
							しかしながら、私たち学生は皆様の経済的な支えなくしては工大祭を運営することができません。
							つきましては、今年度も工大祭を運営するためにも皆様のお力をどうかお貸しいただきたいと思っております。
							皆様からいただいた広告費や協賛品はすべて工大祭の運営に使用させていただきます。
							コロナ禍で厳しい状況にはあると思いますが、実りある学祭のためのお力添えにご理解とご協力を賜りますようお願い申し上げます。
							</p>
							<Grid container direction="row" spacing={1} alignItems="center">
							<Grid item>
								<ArrowRightIcon fontSize="large" style={{ color: "gray" }} />
